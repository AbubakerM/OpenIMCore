...
Pod::Spec.new do |spec|
  ...
  spec.name         = "OpenIMCore"
  spec.version      = "0.0.1"
  spec.summary      = "Open-IM-SDK-Core"
  ...
  spec.author             = { "Abubaker" => "abubker@peakperformances.io" }
  # Or just: spec.author    = "Abubaker"
  # spec.authors            = { "Abubaker" => "abubker@peakperformances.io" }
  # spec.social_media_url   = "https://twitter.com/Abubaker"
